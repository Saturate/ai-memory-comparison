...
function writeSchema(filename: string, schema: z.ZodType, meta: { title: string; description: string }) {
...
writeSchema("developer-tool.schema.json", DevToolSchema, {
  ...
  description: "Schema for AI developer memory tool entries in data/developer-tools/",
});

writeSchema("user-memory.schema.json", UserMemorySchema, {
  title: "User Memory Platform",
  description: "Schema for AI user memory platform entries in data/user-memory/",
});
